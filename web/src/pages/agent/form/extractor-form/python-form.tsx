...
// Python-backend extractor form: the Python Extractor component only reads
// the legacy flat fields (field_name / sys_prompt / prompts), so this form
// is kept unchanged from before the Go modularization.
...
type ExtractorFormSchemaType = z.infer<typeof FormSchema>;
