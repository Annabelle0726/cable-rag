  ...
  translation: {
    ...
    skills: {
      ...
      deleteSelectedDescription:
        'The selected {{count}} skill spaces and their versions will be deleted.',
      deleteSelectedTitle: 'Delete selected skill spaces?',
      description: 'Description',
      name: 'Name',
      renameSpaceDescription: 'Enter a new name for the skill space',
      renameSpaceTitle: 'Rename skill space',
      sortAsc: 'Sort ascending',
      sortDesc: 'Sort descending',
      space: 'spaces',
      spaceUpdated: 'Skill space renamed',
    ...
    skillSearch: {
      ...
      reindexError: 'Failed to rebuild the index',
    },
    memories: {
      llmTooltip:
      ...
      llm: 'LLM',
      delMemoryWarn:
        'After deletion, all messages in this memory will be deleted and cannot be retrieved by agents.',
      descriptionPlaceholder: 'Enter a description',
      memoryTypePlaceholder: 'Select a memory type',
    },
    memory: {
      taskLogDialog: {
        title: 'Memory',
      ...
      messages: {
        ...
        content: 'Content',
        delMessageWarn:
          'After forgetting, this message will not be retrieved by agents.',
    ...
    knowledgeDetails: {
      ...
      metadata: {
        ...
        deleteSettingFieldWarn:
          "This field will be deleted; existing metadata won't be affected.",
        deleteSettingValueWarn:
          "This value will be deleted; existing metadata won't be affected.",
      },
      ...
      taskPageSizeTip:
        'During layout recognition, a PDF file is split into chunks and processed in parallel to increase processing speed. This parameter sets the size of each chunk. A larger chunk size reduces the likelihood of splitting continuous text between pages.',
      addPage: 'Add page',
      ...
      pleaseSelectFileList: 'Please select a non-empty file list',
    },
    knowledgeConfiguration: {
      ...
      settings: 'Settings',
      autoMetadataTip:
        "Automatically generate metadata. Applies to new files during parsing. Existing files require re-parsing to update (chunks remain preserved). Be aware that extra tokens will be consumed by the indexing model specified in 'Configuration'.",
      ...
      pageRank: 'Page rank',
      pageRankTip:
        'You can assign a higher PageRank score to specific datasets during retrieval. The corresponding score is added to the hybrid similarity scores of retrieved chunks from these datasets, increasing their ranking. See https://ragflow.io/docs/dataset_configuration#basic-information for details.',
      tagName: 'Tag',
      ...
      resolutionTip:
        "An entity deduplication switch. When enabled, the LLM will combine similar entities - e.g., '2025' and 'the year of 2025', or 'IT' and 'Information Technology' - to construct a more accurate graph",
      ...
      top: 'Top',
      enableAutoGenerateTip: 'Generate keywords for every chunk automatically.',
      llmModel: 'LLM',
      mineruLanguage: 'Language',
      mineruLanguageTip: 'Language hint passed to the MinerU parser.',
    },
    chunk: {
      type: 'Type',
      docType: {
    ...
    chat: {
      ...
      emptyResponseTip:
        'Set this as a response if no results are retrieved from the datasets for your query, or leave this field blank to allow the LLM to improvise when nothing is found. This setting only takes effect when Thinking Mode is set to Naive.',
      emptyResponseMessage:
        "Empty response will be triggered when nothing relevant is retrieved from datasets. You must clear the 'Empty response' field if no dataset is selected.",
      ...
      topN: 'Top N',
      topNTip:
        "Not all chunks with similarity score above the 'similarity threshold' will be sent to the LLM. This selects 'Top N' chunks from the retrieved ones.",
      ...
      keywordTip:
        "Use LLM to analyze user's questions, extract keywords which will be emphasize during the relevance computation. Works well with lengthy queries but will increase response time.",
      languageTip:
    ...
    message: {
      ...
      '400':
        'There was an error in the request issued, and the server did not create or modify data.',
      '401': 'Please sign in again.',
      '403': 'The user is authorized, but access is prohibited.',
      '404':
        'The request was made for a record that does not exist, and the server did not perform the operation.',
      '406': 'The requested format is not available.',
      '410':
        'The requested resource has been permanently deleted and will not be available again.',
      ...
      '502': 'Gateway error.',
      '503':
        'The service is unavailable and the server is temporarily overloaded or undergoing maintenance.',
      '504': 'Gateway timeout.',
    ...
    flow: {
      ...
      user: 'User',
      assistant: 'Assistant',
      chunkTokenCap: 'Chunk token cap',
      chunkTokenCapTip: 'Maximum number of tokens a single chunk may contain.',
      includeDownloadInfoInContent: 'Include download link in the content',
    },
    llmTools: {
      bad_calculator: {
        name: 'Calculator',
